...
function Game() { 
    ...
    const dropGold = () => {
        setGold(gold => gold + (Math.round(enemyMaxHealth / 5)) + goldBoost)
    }
            ...
            <div className='ui'>
                ...
                <div className='upgrades'>
                    ...
                    <button className='autoFighterUpgrade' onClick={() => 
                        {checkPrice(fireMageUpgradePrice, 2 + (2 * Math.floor(fireMageLevel / 5)), 0, 0, setFireMageUpgradePrice, setFireMageLevel)}}>
                    ...
                    {firstIdleBought && <div className='autoUpgrades'>
                        ...
                        <button className='autoFighterUpgrade' onClick={() => 
                            {checkPrice(iceMageUpgradePrice, 0, 0, 5 + (5 * Math.floor(iceMageLevel / 2)), setIceMageUpgradePrice, setIceMageLevel)}}>
                    ...
                    {firstRebirth && <div className='rebirthUpgrades'>
                        ...
                        <button className='autoFighterUpgrade' onClick={() => 
                            checkSouls(warriorUpgradePrice, 5 + (5 * Math.floor(warriorLevel / 5)), 0, 0, 0, setWarriorUpgradePrice, setWarriorLevel)}>
                        ...
                        <button className='autoFighterUpgrade' onClick={() => 
                            checkSouls(farmUpgradePrice, 0, 10 + (10 * Math.floor(farmLevel / 2)), 0, 0, setFarmUpgradePrice, setFarmLevel)}>
